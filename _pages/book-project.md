...
<figure>
  ...
  <figcaption>The rise of opposition, globally, from 1945 to 2020. Panel (a) shows the annual count of legislative elections held in authoritarian regimes, distinguishing elections in which at least one opposition party competed in the election. Smooth curves are locally estimated scatterplot smoothing (LOESS) fits. Panel (b) shows mean opposition strength across authoritarian regimes annually, measured by the size of opposition, opposition seat share in the legislature, and opposition vote share in the most recent election. The shaded region denotes the Third Wave of democratization (1974–1989). Sample restricted to independent states.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The number of registered tribespeople across several electoral districts prior to the 1985 National Assembly election. Souce: Al-Naqeeb, Khaldoun. 1985. "Tawzīʿ Aṣwāt `al-Ḥizām al-Qabalī' fī Intikhābāt 85: Al-Qabas Tarṣud Kathāfat Nāikhibī al-Qabāʾil fī 15 Dāʾira Intikhābiyya [Distribution of Votes of the 'Tribal Belt' in the 85 Election: Al-Qabas Records the Density of Tribal Voters in 15 Electoral Districts]." Al-Qabas, January 12.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The expansion of ideological representation and voting over time. Panel (a) shows the number of seats ideological candidates won in each general election. Panel (b) shows the national-level share of votes candidates representing each ideological group won in each election. Because each elector has multiple votes in these elections, vote shares are transformed using the Swiss "fictional voter" method. </figcaption>
</figure>
...
<figure>
  <img src="/assets/img/7.4.png" alt="">
  <figcaption>Bimonthly counts of laws passed (a), legislative queries (b), legislative recommendations (c), and law proposals (d) in the Kuwait National Assembly from 1963 to 2008. Periods of unconstitutional dissolution (1976–1981, 1986–1992) are excluded. The y-axis uses a square root scale, which compresses larger values to allow periods of high and low activity to be visualized on the same axis. Black lines indicate locally weighted (LOESS) trend lines, estimated separately so that unconstitutional dissolutions are excluded. Dashed red lines indicate the start of a new legislative term. Source: Parliamentary Information System, National Assembly of Kuwait.</figcaption>
</figure>
